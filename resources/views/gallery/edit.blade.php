...
<input class="btn btn-primary" type="button" value="Clear Canvas" onclick="clearCanvas();">
    <form  method='POST' action='/drawing/edit'>
        {{ csrf_field() }}
...
if(canvas.getContext) 
{
  ...
  screenshotImage.src = "{{asset('storage/'.$filename)    }}";    
    // set the defaults
